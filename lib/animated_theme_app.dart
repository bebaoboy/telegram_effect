...
import 'package:clone_telegram/circular_animation/circular_animated_theme.dart';
...
// =======
  ...
  @override
  State<AnimatedThemeApp> createState() => _MaterialAppState();
      ...
      default:
        if (widget.themeAnimationStyle != AnimationStyle.noAnimation) {
          ...
          childWidget = AnimatedTheme(
            ...
            curve:
                widget.themeAnimationStyle?.curve ?? widget.themeAnimationCurve,
            child: childWidget,
          );
        } else {
          childWidget = Theme(
